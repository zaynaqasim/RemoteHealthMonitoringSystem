    ...
    public void viewMedicalHistory() {
     ...
     public void handle(Scanner sc, ArrayList<Doctor> doctors, AppointmentManager manager,
        ...
        while (true) {
            ...
            switch (ch) {
                case 1:
                    System.out.print("Heart Rate: "); int hr = sc.nextInt();
                    System.out.print("Oxygen: "); int ox = sc.nextInt();
                    System.out.print("BP: "); String bp = sc.next();
                    System.out.print("Temp: "); double temp = sc.nextDouble(); sc.nextLine();
                ...
                case 3:
                    ...
                    System.out.print("Doctor Name: "); String docName = sc.nextLine();
                ...
                case 8:
                    ...
                    videoCall.startCall(name, dname); break;
                case 9:
                    reminderService.sendAppointmentReminder(this); break;
                case 10:
                    emergencyAlert.triggerAlert("Patient " + name + " triggered emergency!");
                    break;
                case 0: return;
...
class AppointmentManager {
    ...
    public ArrayList<Appointment> findAppointmentsByPatientName(String patientName) {
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 2:
                    ...
                    ArrayList<Appointment> appts = findAppointmentsByPatientName(name);
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 2:
                    ...
                    System.out.print("Email: "); String demail = sc.nextLine();
                    System.out.print("Password: "); String dpass = sc.nextLine();
