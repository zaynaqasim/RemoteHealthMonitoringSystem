 ...
 */
package remote.health.monitoring.system;
    ...
    public void viewMedicalHistory() {
     ...
     public void handle(Scanner sc, ArrayList<Doctor> doctors, AppointmentManager manager,
        ...
        while (true) {
            ...
            switch (ch) {
                case 1:
                    System.out.print("Enter Heart Rate: "); int hr = sc.nextInt();
                    System.out.print("Enter Oxygen: "); int ox = sc.nextInt();
                    System.out.print("Enter BP: "); String bp = sc.next();
                    System.out.print("Enter Temp: "); double temp = sc.nextDouble(); sc.nextLine();
                ...
                case 3:
                    ...
                    System.out.print("Enter your preferred Doctor's Name: "); String docName = sc.nextLine();
                    Doctor d = RemoteHealthMonitoringSystem.findDoctorByName(doctors, docName);
                    if (d != null) {
                        System.out.print("Enter your preferred Appointment Date (YYYY-MM-DD): "); String date = sc.nextLine();
                ...
                case 5:
                    ...
                    break;
                case 6: panicButton.press(); break;
                case 7:
                    System.out.print("Message: "); String msg = sc.nextLine();
                    chatClient.sendMessage(msg); break;
                case 8:
                    System.out.print("Doctor Name: "); String dname = sc.nextLine();
                    videoCall.startCall(getName(), dname); break;
                case 9:
                    reminderService.sendAppointmentReminder(this); break;
                case 10:
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 2:
                    ...
                    Patient p = RemoteHealthMonitoringSystem.findPatientById(patients, pid);
                    if (p != null) {
                        System.out.print("Enter Feedback for your patient: "); String fb = sc.nextLine();
                        addFeedback(p, fb);
                    }
                    break;
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 2:
                    ...
                    ArrayList<Appointment> appts = findAppointmentsByPatientID(id);
                    if (appts.isEmpty()) System.out.println("[No Appointments]");
                        ...
                        if (i >= 0 && i < appts.size()) {
                            ...
                            if (d == 1) approveAppointment(appts.get(i));
                            else rejectAppointment(appts.get(i));
                        }
                    }
                    break;
                case 0: return;
        ...
        while (true) {
            ...
            switch (ch) {
                case 1:
                    ...
                    System.out.print("Enter Patient Email: "); String email = sc.nextLine();
                    addPatient(id, name, email);
                    break;
                case 2:
                    System.out.print("Enter Doctor ID: "); String did = sc.nextLine();
                    System.out.print("Enter Doctor Name: "); String dname = sc.nextLine();
                    System.out.print("Enter Doctor Email: "); String demail = sc.nextLine();
                    System.out.print("Enter Doctor Password: "); String dpass = sc.nextLine();
                    addDoctor(did, dname, demail, dpass);
                    break;
...
class MedicalHistory {
    ...
    public void displayHistory() {
        ...
        System.out.println("Past Consultations: " + pastConsultations);
    }
}
...
public class RemoteHealthMonitoringSystem {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("[0] Exit");
            System.out.println("Select an option based on your role: ");
            ...
            switch (ch) {
                ...
                case 2:
                    ...
                    if (d != null) {
                        ...
                        if (d.authenticate(scanner.nextLine())) {
                ...
                case 3:
                    ...
                    if (admin.authenticate(u, pw)) admin.handle(scanner);
